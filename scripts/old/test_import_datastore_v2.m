...
inputLayer = imageInputLayer([256 512 3], 'Name','input','Normalization', 'none');
...
pximdsVal = pixelLabelImageDatastore(imdsVal,pxdsVal); % 'DispatchInBackground',true
...
pximds = pixelLabelImageDatastore(imdsTrain,pxdsTrain,...
    'DataAugmentation',augmenter); % 'DispatchInBackground',true, 
